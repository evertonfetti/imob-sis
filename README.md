...
- **Devolver ao robô:** em *Conversas* há *Assumir*, *Devolver ao robô* e *Finalizar*. Ao devolver, o assistente volta a responder **na próxima mensagem** do cliente (não puxa assunto). Uma pessoa que responde pelo painel assume a conversa sozinha; conversa **finalizada** reabre com o assistente quando o cliente escreve de novo.
