...
export const ERROR_CODES = {
  ...
  AI_MODEL_INVALID: 'Este modelo de IA não está disponível (removido, desativado ou de uma conta desativada).',
  AI_ACCOUNT_DUPLICATE: 'Já existe um modelo com este ID nesta conta.',
  AGENT_MODEL_REQUIRED: 'Escolha um modelo de texto para ativar o agente.',
