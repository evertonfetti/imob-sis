...
const ENTITIES = { AUTH: 'Acesso', USER: 'Usuário', COMPANY: 'Empresa', BRANCH: 'Filial', PROPERTY: 'Imóvel', OWNER: 'Proprietário', PROPERTY_TYPE: 'Tipo de imóvel', FEATURE: 'Característica' } as const;
const ACTIONS: Record<string, [string, 'ok' | 'warn' | 'danger' | 'accent' | undefined]> = {
  ...
  PASSWORD_RESET: ['Senha redefinida', 'warn'], PUBLISH: ['Publicação', 'ok'], UNPUBLISH: ['Despublicação', 'warn'], ARCHIVE: ['Arquivamento', 'warn'], DELETE: ['Exclusão', 'danger'], PASSWORD_RESET_REQUESTED: ['Redefinição solicitada', undefined],
};
