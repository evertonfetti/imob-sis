...
const ENTITIES = { AUTH: 'Acesso', USER: 'Usuário', COMPANY: 'Empresa', BRANCH: 'Filial' } as const;
const ACTIONS: Record<string, [string, 'ok' | 'warn' | 'danger' | 'accent' | undefined]> = {
  ...
  PASSWORD_RESET: ['Senha redefinida', 'warn'], PASSWORD_RESET_REQUESTED: ['Redefinição solicitada', undefined],
};
